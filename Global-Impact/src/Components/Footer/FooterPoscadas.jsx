        ...
        <div className=" rodape">
            ...
            <div className="d-flex justify-content-center align-items-start mrgr-grande" style={{ width: "100%" }}>
                <ul className="rodape-itens mx-1">
                    <li>
                        <Link to="/cadastraralimentos" className="linkreact text-dimgrayroda-link font-weight-bold itens">Cadastrar alimentos</Link>
                    </li>
                </ul>

                <ul className="rodape-itens mx-1">
                    <li>
                        <Link to="/funcSupermercado" className="linkreact text-black roda-link font-weight-bold itens">Visualizar reservas</Link>
                    </li>
